...
/**
 * 🛡️ SAFE FOOTAGE PARSER: Prevents Dates and garbage characters from being read as footage.
 */
function safeParseFootage(val) {
  if (val === "" || val === null || val === undefined) return 0;
  if (val instanceof Date) return 0; // Dates are the primary cause of trillions-of-feet anomalies
  
  let strVal = String(val).trim();
  // Strip commas, quotes, and foot markers, keep decimals and signs
